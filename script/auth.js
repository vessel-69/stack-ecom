  ...
  list.innerHTML = cart
    .map(function (item, i) {
      ...
      return (
        ...
        '<button class="cp-qty-btn cp-dec" onclick="changeQty(' +
        i +
        ',-1)">&#8722;</button>' +
        '<span class="cp-qty-num">' +
        item.qty +
        "</span>" +
        '<button class="cp-qty-btn cp-inc" onclick="changeQty(' +
        i +
        ',1)">&#43;</button>' +
        "</div>" +
        '<button class="cp-remove-btn" onclick="removeFromCart(' +
        i +
